...
**EXAMPLE 2. List files containing 'test' in the current directory, capture stdout to a log, and also display it on screen:**
...
**EXAMPLE 3. List files containing 'test', capturing stdout and stderr to separate log files:**
...
**EXAMPLE 4. Add the executable 'test3' for deferred execution on PBS:**
